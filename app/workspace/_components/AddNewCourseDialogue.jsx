                    ...
                    <DialogDescription asChild>
                        <div className="flex flex-col gap-4 mt-3">
                            ...
                            <div>
                                ...
                                onChange={(event)=>onHandleInputChange('description',event?.target.value)}></Textarea>
                            </div>
                            <div>
                                <label>No. Of Chapters</label>
                                <Input placeholder="No. of chapters" type='number'
                                onChange={(event)=>onHandleInputChange('noOfChapters',event?.target.value)}></Input>
                            </div>
                            ...
                            <div>
                                ...
                                onChange={(event)=>onHandleInputChange('category',event?.target.value)}></Input>
                            </div>
