              ...
              <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                  <div className="relative z-10 w-full max-w-md">
                      ...
                      <div className=" mt-16 space-y-3">
                          <h3 className="text-white text-3xl font-bold">Welcome to AI CoursePedia</h3>
                          <p className="text-gray-300">
                          Generates customized courses based on your input topics or goals. It streamlines content creation for learners, educators, and developers.
                          </p>
